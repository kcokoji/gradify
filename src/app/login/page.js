...
export default function Login() {
  ...
  return (
    <div className="flex justify-center items-center min-h-screen">
        ...
        <div className="mx-auto max-w-2xl text-start">
          <div>
            ...
            <p className="mt-2 text-lg leading-8 text-gray-600">
              Welcome back! Enter your details and continue where you left off.
            </p>
          </div>
        </div>
        <form onSubmit={loginUser} className="mx-auto mt-8 max-w-xl sm:mt-15">
      ...
      <div className="lg:flex justify-center items-center hidden p-20">
        <Image
